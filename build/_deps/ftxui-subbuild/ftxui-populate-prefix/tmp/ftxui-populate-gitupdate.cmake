...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/mnt/c/Programas/Programming/repos/weather-wpp/build/_deps/ftxui-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/mnt/c/Programas/Programming/repos/weather-wpp/build/_deps/ftxui-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
...
if(init_submodules)
  execute_process(
    COMMAND "/usr/sbin/git" --git-dir=.git submodule update --recursive --init 
    WORKING_DIRECTORY "/mnt/c/Programas/Programming/repos/weather-wpp/build/_deps/ftxui-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
endif()
